...
define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'mypci/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
    'use strict';
    ...
    qtiCustomInteractionContext.register(mypci);
});
